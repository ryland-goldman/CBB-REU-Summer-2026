"""
Figures for the WarpX RZ CESR-gun simulation over gun/diags/. Writes PNGs to gun/results/.

Two layers: generic phase-space / trend figures via lume-warpx's helpers and the shared
`pipeline.plot_extras` beam figures, plus the stage-specific rich figures (on-axis applied
field, r–z transport, local-in-z energy gain and envelope via fixed-z virtual screens, and
the beam self-field). See gun/README.md for the physics each figure shows.
"""
...
PARTICLES = "gun/diags/particles"
FIELDS = "gun/diags/fields"
...
def main():
    ...
    if live_iters:
        ...
        screen_figures(_pool_trajectories(ts, live_iters))
