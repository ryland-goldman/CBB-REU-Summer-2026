<a id="dataanalysis-visualization-visit"></a>

# 3D Visualization: VisIt

WarpX results can be visualized by VisIt, an open source visualization and analysis software. VisIt can be downloaded and installed from [https://wci.llnl.gov/simulation/computer-codes/visit](https://wci.llnl.gov/simulation/computer-codes/visit).
...
![Visit visualization of Ez field component](dataanalysis/Ez.png)
