<a id="dataanalysis-openpmd-viewer"></a>

# openPMD-viewer

[openPMD-viewer](https://github.com/openPMD/openPMD-viewer) is an open-source Python package to access openPMD data.
...
For interactive plots in Jupyter notebook or Jupyter Lab, add this [“cell magic”](https://ipython.readthedocs.io/en/stable/interactive/magics.html) to the first line of your notebook:
...
See the openPMD-viewer tutorials [here](https://github.com/openPMD/openPMD-viewer/tree/dev/docs/source/tutorials) for more info.
