<a id="dataanalysis-workflows-tunneling"></a>
...
For example, see the [NERSC Jupyter](../../install/hpc/perlmutter.md#post-processing-perlmutter) and [OLCF Jupyter](../../install/hpc/frontier.md#post-processing-frontier) services.

<a id="dataanalysis-workflows-tunneling-background"></a>
...
<a id="dataanalysis-workflows-tunneling-workflow"></a>
...
![Remote Jupyter setup with SSH tunnel and local browser connection](https://user-images.githubusercontent.com/1353258/232120440-3965fa38-9ca6-4621-a100-2da74eb899cf.png)
