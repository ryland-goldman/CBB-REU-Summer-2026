...
[optimas](https://github.com/optimas-org/optimas) is an open-source Python library that enables highly scalable parallel optimization, from a typical laptop to exascale HPC systems.
...
A more detailed description of optimas is provided in the [optimas documentation](https://optimas.readthedocs.io/en/latest/).
In particular, the online optimas documentation provides [an example optimization with optimas that runs WarpX simulations](https://optimas.readthedocs.io/en/latest/examples/bo_with_warpx.html).
