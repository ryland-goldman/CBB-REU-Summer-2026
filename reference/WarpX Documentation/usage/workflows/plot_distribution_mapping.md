...
WarpX provides via [reduced diagnostics](../../dataanalysis/formats.md#dataanalysis-formats-reduced) an output
[LoadBalanceCosts](../parameters.md#running-cpp-parameters-diagnostics), which
...
The line [`warpx.reduced_diags_names = LBC`](../parameters.md#warpx.reduced_diags_names) sets the name of the reduced diagnostics
output file to `LBC`.  The next line [`LBC.type = LoadBalanceCosts`](../parameters.md#reduced_diags_name-.type) tells WarpX
...
[`plot_distribution_mapping.py`](../../../../Tools/PostProcessing/plot_distribution_mapping.py)
...
This generates plots like in [[fig:knapsack_sfc_distribution_mapping_2D]](#fig:knapsack_sfc_distribution_mapping_2D):

\\centering![Comparison of knapsack vs space-filling curve distribution mappings](usage/workflows/knapsack_sfc_distribution_mapping_2D.png)
...
This generates plots like in [[fig:knapsack_sfc_costs_2D]](#fig:knapsack_sfc_costs_2D):

\\centering![Computational cost comparison between knapsack and space-filling curve methods](usage/workflows/knapsack_sfc_costs_2D.png)
...
This generates plots like in [[fig:distribution_mapping_3D]](#fig:distribution_mapping_3D):

\\centering![3D distribution mapping slices in the ik plane](usage/workflows/distribution_mapping_3D.png)
