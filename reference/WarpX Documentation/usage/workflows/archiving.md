...
<a id="archiving-hpss"></a>

## HPC Systems: HPSS

A very common tape filesystem is HPSS, e.g., on [NERSC](https://docs.nersc.gov/filesystems/archive/) or [OLCF](https://docs.olcf.ornl.gov/data/index.html#data-storage-and-transfers).
...
Tools like [rclone](https://rclone.org) can help with this, e.g., to quickly sync a large amount of directories to a Google Drive.

<a id="archiving-globus"></a>

## Asynchronous File Copies: Globus

The scientific data service [Globus](https://app.globus.org) allows to perform large-scale data copies, between HPC centers as well as local computers, with ease and a graphical user interface.
...
For data artifacts up to approximately 50 GB, consider using free services like [Zenodo](https://www.zenodo.org) and [Figshare](https://figshare.com) to store supplementary materials of your publications.
