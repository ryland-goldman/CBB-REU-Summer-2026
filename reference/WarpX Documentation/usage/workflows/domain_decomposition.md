<a id="usage-domain-decomposition"></a>
...
#### NOTE
The AMReX documentation on [Grid Creation](https://amrex-codes.github.io/amrex/docs_html/GridCreation.html#sec-grid-creation) may also be helpful.
...
[Load Balancing](https://amrex-codes.github.io/amrex/docs_html/LoadBalancing.html)
...
[`Python script`](../../../../Tools/DevUtils/compute_domain.py) does it
automatically.

When using the RZ spectral solver, the values of [`amr.max_grid_size`](../parameters.md#amr.max_grid_size) and `amr.blocking_factor` are constrained since the solver
