...
The script `update_dependencies.py` from [Tools/Release/update_dependencies.py](https://github.com/BLAST-WarpX/warpx/blob/development/Tools/Release/update_dependencies.py) automates this workflow, in case one needs a newer commit of AMReX, pyAMReX, or PICSAR between releases:
...
>    **Publish**: On the [GitHub Release page](https://github.com/BLAST-WarpX/warpx/releases), create a new release via `Draft a new release`.
