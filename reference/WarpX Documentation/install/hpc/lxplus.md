...
* Batch system: [HTCondor](https://batchdocs.web.cern.ch/index.html)
...
**That’s it!**
A 3D WarpX executable is now in `build/bin/` and can be run with a [3D example inputs file](../../usage/examples.md#usage-examples).
