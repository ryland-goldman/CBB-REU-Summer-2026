...
1. Go to [https://github.com/settings/profile](https://github.com/settings/profile) and add your real name and affiliation
2. Go to [https://github.com/settings/emails](https://github.com/settings/emails) and add & verify the professional e-mails you want to be associated with.
3. Configure `git` on the machine you develop on to *use the same spelling of your name and email*:
   - `git config --global user.name "FIRSTNAME LASTNAME"`
   - `git config --global user.email EMAIL@EXAMPLE.com`
4. Go to [https://github.com/settings/keys](https://github.com/settings/keys) and add the SSH public key of the machine you develop on. (Check out the GitHub guide to [generating SSH keys](https://docs.github.com/articles/generating-an-ssh-key/) or [troubleshoot common SSH problems](https://docs.github.com/ssh-issues/). )
...
* WarpX Doxygen: [https://warpx.readthedocs.io/en/latest/_static/doxyhtml](https://warpx.readthedocs.io/en/latest/_static/doxyhtml)
* AMReX Doxygen: [https://amrex-codes.github.io/amrex/doxygen](https://amrex-codes.github.io/amrex/doxygen)
* PICSAR Doxygen: (todo)
...
Instructions are given in the [testing section](how_to_test.md#developers-testing) of our [developer’s documentation](https://warpx.readthedocs.io/en/latest/developers/testing.html).
...
For instance, if you introduce a new runtime parameter in the input file, you can add it to [Docs/source/running_cpp/parameters.rst](../usage/parameters.md#running-cpp-parameters).
...
- `#include` directives in C++ have a distinct order to avoid bugs, see [the WarpX repo structure](repo_organization.md#developers-repo-structure) for details
