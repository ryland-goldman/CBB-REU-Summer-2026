<a id="developers-repo-structure"></a>
...
Here is a [visual representation](https://mango-dune-07a8b7110.1.azurestaticapps.net/?repo=ECP-WarpX%2FWarpX) of the repository structure.
...
WarpX uses the [CMake build system generator](../install/cmake.md#install-build-cmake).
...
For experienced developers, we also support AMReX’ [GNUmake build script collection](gnumake.md#developers-gnumake).
...
<a id="developers-cpp-includes"></a>
...
The include order (see [PR #874](https://github.com/BLAST-WarpX/warpx/pull/874#issuecomment-607038803) and [PR #1947](https://github.com/BLAST-WarpX/warpx/pull/1947)) and [proper quotation marks](https://gcc.gnu.org/onlinedocs/cpp/Include-Syntax.html) are:
...
For details why this is needed, please see [PR #874](https://github.com/BLAST-WarpX/warpx/pull/874#issuecomment-607038803), [PR #1947](https://github.com/BLAST-WarpX/warpx/pull/1947), the [LLVM guidelines](https://llvm.org/docs/CodingStandards.html#include-style), and [include-what-you-use](https://github.com/include-what-you-use/include-what-you-use/blob/master/docs/WhyIWYU.md).

<a id="developers-cpp-includes-fwd"></a>

## Forward Declaration Headers

[Forward declarations](https://en.wikipedia.org/wiki/Forward_declaration) can be used when a header file needs only to know that a given class exists, without any further detail (e.g., when only a pointer to an instance of
