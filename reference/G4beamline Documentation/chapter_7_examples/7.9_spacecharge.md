## 7.9 SpaceCharge.g4bl

# or a cluster. the .root and .out files are named for $first (may
# need to be changed on a grid).

param -unset first=0 last=999999
...
momentum of the reference and bunch center
#
sigmaP

sigmaP of the initial beam
#
...
#
nGrid
# points in each dimension of the grid
#
nApprox

# points in each dimension of the approximation
#
maxBeta

max beta in reference frome for bunch
#
