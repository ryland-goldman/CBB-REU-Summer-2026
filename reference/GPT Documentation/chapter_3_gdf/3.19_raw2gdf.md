...
-d
```
Specify when data is given in double-precision numbers.
...
infile
```
Name of the binary file to be converted.

```
arr1
```
Name of the array as it is to be specified in the outputfile.

```
fac1
```
Multiplication factor for `arr1`. **…** Specify all arrays present in `infile` with their conversion factor.
