...
- **`scat_x`** — Array of the *x* coordinates of the ‘hits’ [m]

- **`scat_y`** — Array of the y coordinates of the ‘hits’ [m]

- **`scat_z`** — Array of the z coordinates of the ‘hits’ [m]

- **`scat_Qin`** — Corresponding total charge of incident particle [C]

- **`scat_Qout`** — Corresponding total charge of scattered particle(s) [C]

- **`scat_Qnet`** — `scat_Qin`–`scat_Qout`

- **`scat_Ein`** — Corresponding total kinetic energy of incident particle [J]

- **`scat_Eout`** — Corresponding total kinetic energy of scattered particle (s) [J]

- **`scat_Enet`** — `scat_Ein`–`scat_Eout`

- **`scat_inp`** — Cos(angle of incidence)
