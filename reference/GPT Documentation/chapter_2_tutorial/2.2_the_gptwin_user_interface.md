...
stdx
```
Standard *x*-deviation of the particles: A measure for the beam size in the *x* direction.

```
stdy
```
Standard *y*-deviation of the particles: A measure for the beam size in the *y* direction.

```
avgz
```
Average *z*-coordinate of the particles: Beam position.
